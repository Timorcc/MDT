...
// When the player is first initialized, trigger activiti so components
  ...
  if (bool !== undefined) {
    ...
    if (bool !== this.userActive_) {
      ...
      if (bool) {
        ...
        // activiti. Making it impossible to go into inactive mode. Specifically
...
vjs.Player.prototype.listenForUserActivity = function(){
  ...
  onMouseUp = function(event) {
    onMouseActivity();
    // Stop the interval that maintains activiti if the mouse/touch is down
    clearInterval(mouseInProgress);
  };

  // Any mouse movement will be considered user activiti
  ...
  // Consider any touch events that bubble up to be activiti
  ...
  activityCheck = setInterval(vjs.bind(this, function() {
    // Check to see if mouse/touch activiti has happened
    if (this.userActivity_) {
      // Reset the activiti tracker
      this.userActivity_ = false;
      ...
      // In X seconds, if no more activiti has occurred the user will be
      // considered inactive
      inactivityTimeout = setTimeout(vjs.bind(this, function() {
        // Protect against the case where the inactivityTimeout can trigger just
        // before the next user activiti is picked up by the activityCheck loop
        // causing a flicker
        if (!this.userActivity_) {
 ...
 * is a touch and hold on the video element counting as activiti in order to
...
vjs.MediaTechController.prototype.addControlsListeners = function(){
  ...
  // otherwise they'll signal activiti prematurely. The specific use case is
  ...
  // report activiti on the other events, but won't let them bubble for
 ...
 * activiti state, which hides and shows the controls.
 */
